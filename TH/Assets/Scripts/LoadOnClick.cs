...
public class LoadOnClick : MonoBehaviour
{
    ...
    public double RealPlayerCredits
    {
        set
        {
            ...
            if (playerAllCredits && playerAllCredits.GetComponent<Text>().IsActive()) playerAllCredits.GetComponent<Text>().text = dollarAmount;
        }
        get
        {
    ...
    {
        if (Settings.isDebug) Debug.Log("GameOverTimer()");
    ...
    private void nextPlayerTimer_Tick()//object sender, EventArgs e)
    {
        if (Settings.isDebug) Debug.Log("nextPlayerTimer()");
        if (isNextPlayer)
        {
            NextPlayer();
        }
    ...
    private void BuildVirtualPlayerProfilesFromIniFile()
    {
        if (Settings.isDebug) Debug.Log("BuildVirtualPlayerProfilesFromIniFile()");
        int i = 0;
        bool done = false;
        int test;
        int test1;
    ...
    private void BuildVirtualPlayerProfiles()
    {
        if (Settings.isDebug) Debug.Log("BuildVirtualPlayerProfiles()");
    ...
    private void ShuffleVirtualPlayers()
    {
        if (Settings.isDebug) Debug.Log("ShuffleVirtualPlayers()");
    ...
    private void updateBettingButtonTitle()
    {
        if (Settings.isDebug) Debug.Log("updateBettingButtonTitle()");

        switch (GameState)
        {
            case GameStates.HoldCardBet:
                {
                    lblGameState.GetComponent<Text>().text = betButtonTitles[0];
                }
                break;
            case GameStates.FlopBet:
                {
                    lblGameState.GetComponent<Text>().text = betButtonTitles[1];
                }
                break;
            case GameStates.TurnBet:
                {
                    lblGameState.GetComponent<Text>().text = betButtonTitles[2];
                }
                break;
            case GameStates.RiverBet:
                {
                    lblGameState.GetComponent<Text>().text = betButtonTitles[3];
                }
                break;
            case GameStates.EndGame:
                {
                    lblGameState.GetComponent<Text>().text = betButtonTitles[4];
                }
                break;
            case GameStates.PlayerWin:
                {
                    lblGameState.GetComponent<Text>().text = betButtonTitles[5];
                }
                break;
        }
    }

    private void updateFoldedPlayersImages(bool visible)
    {
        if (Settings.isDebug) Debug.Log("updateFoldedPlayersImages()");
    ...
    private bool getWeightedResult(int value)
    {
    ...
    private int getWeightedIntResult(int value)
    {
        int temp = rand.Next(100);
        if (temp <= value)
        {
    ...
    {
        if (Settings.isDebug) Debug.Log("DealNextRound()");
    ...
    private void UpdateBetLabel(string text, int player, bool yellow)
    {
        if (Settings.isDebug) Debug.Log("UpdateBetLabel(string text, int player, bool yellow)");
    ...
    {
        if (Settings.isDebug) Debug.Log("UpdateBetLabel(string text, int player, bool yellow) player="+player);
        if (player == 0) return;
    ...
    private void clearBetLabels()
    {
        if (Settings.isDebug) Debug.Log("clearBetLabels()");
    ...
    private void clearCreditLabels()
    {
        if (Settings.isDebug) Debug.Log("clearCreditLabels()");
    ...
    {
        if (Settings.isDebug) Debug.Log("restoreCardDefaults()");

        for (int x = 0; x < Settings.playerSize; x++)
        {
            if (betLabels.ElementAt(x))
            {
                betLabels.ElementAt(x).GetComponent<Text>().text = "";
                betLabels.ElementAt(x).SetActive(false);
            }
    ...
    {
        if (Settings.isDebug) Debug.Log("dealFlop()");
    ...
    {
        if (Settings.isDebug) Debug.Log("dealTurn()");
    ...
    {
        if (Settings.isDebug) Debug.Log("dealRiver()");
    ...
    {
        if (Settings.isDebug) Debug.Log("CallPlayer()");
    ...
    {
        if (Settings.isDebug) Debug.Log("CheckPlayer()");
    ...
    {
        if (Settings.isDebug) Debug.Log("FoldPlayer()");
    ...
    {
        if (Settings.isDebug) Debug.Log("ShowPlayerCards()");
    ...
    {
        if (Settings.isDebug) Debug.Log("ClearPlayerCards()");
    ...
    private int EvaluateFlop(int player, int[] FlopHand)
    {
        if (Settings.isDebug) Debug.Log("EvaluateFlop()");
    ...
    private int EvaluateTurn(int[] TurnHand)
    {
        if (Settings.isDebug) Debug.Log("Evaluat(Turn)");

        return 0;
    }

    private int GetFlushCount(int[] FinalSuit)
    {
        if (Settings.isDebug) Debug.Log("GetFlushCount()");
    ...
    private int GetConnectedStraightRank(int[] FinalValue, int SaveValue)
    {
        if (Settings.isDebug) Debug.Log("GetConnectedStraightRank()");
    ...
    {
        if (Settings.isDebug) Debug.Log("GetInsideStraightRank()");
    ...
    {
        if (Settings.isDebug) Debug.Log("GetFiveCardTotal()");
    ...
    {
        if (Settings.isDebug) Debug.Log("EvaluatePokerHand()");
    ...
    private bool IsPokerHandPossible(int hand, int player, int[] FinalHand)
    {
        if (Settings.isDebug) Debug.Log("IsPokerHandPossible()");
    ...
    {
        if (Settings.isDebug) Debug.Log("GetFiveCardRanking()");
    ...
    private int GetXofaKindTotal(int card, int[] hand)
    {
        if (Settings.isDebug) Debug.Log("GetXofaKindTotal()");
    ...
    private int GetTwoPairTotal(int firstValue, int secondValue, int[] hand)
    {
        if (Settings.isDebug) Debug.Log("GetTwoPairTotal()");
    ...
    {
        if (Settings.isDebug) Debug.Log("EnableBettingButtons()");

        panelInitBet.SetActive(true);  //show the betting buttons

        if (virtualPlayers[0].AllIn == true)
        {
            if (btnRaise) btnRaise.GetComponent<Button>().interactable = false;
            if (btnAllIn) btnAllIn.GetComponent<Button>().interactable = true;
            if (btnFold) btnFold.GetComponent<Button>().interactable = false;

            if (btnAllIn) btnAllIn.GetComponentInChildren<Text>().text = "CONTINUE";
            if (btnCheck) btnCheck.GetComponent<Button>().interactable = false;
            if (btnCall) btnCall.GetComponent<Button>().interactable = false;
            //TODO: replace disabled state on invisible if (btnSurrender) btnSurrender.SetActive(false);
            if (btnSurrender) btnSurrender.GetComponent<Button>().interactable = false;
        ...
        //if (btnAllIn) btnAllIn.GetComponentInChildren<Text>().text = "ALL IN"; // TODO: null object
        CallAmount = GetCurrentBet() - virtualPlayers[0].CurrentBetAmount;
        updateBettingButtonTitle();

        if (btnRaise) btnRaise.GetComponent<Button>().interactable = true;  //we can always raise
        if (btnAllIn && btnAllIn.GetComponent<Button>().IsActive())
        {
            btnAllIn.GetComponentInChildren<Text>().text = "ALL IN";
            btnAllIn.GetComponent<Button>().interactable = true;  //we can alway go all in
        }
        if (btnFold) btnFold.GetComponent<Button>().interactable = true;    //we can always fold

        if (CallAmount == 0)
        {
            if (btnCheck) btnCheck.GetComponent<Button>().interactable = true;
            if (btnCall)
        ...
        if (PlayerCredits == 0)
        {
            ...
            if (btnCall)
                btnCall.GetComponent<Button>().interactable = false;
            if (btnAllIn) btnAllIn.GetComponent<Button>().interactable = false;
        }
        ...
        if (GameState == GameStates.HoldCardBet)
        {
            ...
            {
                if (panelSurrender) panelSurrender.SetActive(true);
                if (btnSurrender) btnSurrender.SetActive(true);
            }
        }
        UpdateDynamicHelp();
    }
    ...
    {
        if (Settings.isDebug) Debug.Log("UpdateDynamicHelp()");

        if (virtualPlayers[0].AllIn == true)
        {
            string contstring = continueString + Environment.NewLine;
            if(lblTemp) lblTemp.text = contstring;
            return;
        }
        string teststring = foldString + Environment.NewLine;

        if (btnCheck && btnCheck.GetComponent<Button>().IsInteractable())
        {
            teststring += checkString + Environment.NewLine;
        }
        if (btnCall && btnCall.GetComponent<Button>().IsInteractable())
        {
            teststring += callString + Environment.NewLine;
        }
        if (btnRaise && btnRaise.GetComponent<Button>().IsInteractable())
        {
            teststring += raiseString + Environment.NewLine;
        }
        if (btnAllIn && btnAllIn.GetComponent<Button>().IsInteractable())
        {
            teststring += allInString + Environment.NewLine;
        }
        if (btnSurrender && btnSurrender.GetComponent<Button>().IsActive())
        {
            teststring += surrenderString;
        }
        if (lblTemp) lblTemp.text = teststring;
    }

    private void DisableBettingButtons()
    {
        if (Settings.isDebug) Debug.Log("DisableBettingButtons()");
        ...
        //TODO: change state to invisible instead disabled if (btnSurrender) btnSurrender.SetActive(false);
        if (btnSurrender) btnSurrender.GetComponent<Button>().interactable = false;
    ...
    //*************************************************************************************************
    //*******************************************************************************************
    private double BetPlayer(int player)
    {
        if (Settings.isDebug) Debug.Log("BetPlayer()");
        ...
        if (player != 0 || AutoPlay == true)//only service  the virtual players here
        {
                    ...
                    if (bluff == true)//are we bluffing
                    {
                        for (int i = 0; i < virtualPlayers[player].BluffHands.Count(); i++)
                        {
                            if (rank == virtualPlayers[player].BluffHands.ElementAt(i))
                            {
                                ...
                                if (lblTestInfo) lblTestInfo.GetComponent<Text>().text += virtualPlayers[player].Name + " is BLUFFING with " + FormatCreditsOrDollars(raise);
                            }
                        }
                    }
                }
            ...
            if (GameState == GameStates.FlopBet)//the flop
            {
                ...
                if (lblTestInfo) lblTestInfo.GetComponent<Text>().text += virtualPlayers[player].Name + " #" + player.ToString() + " Flop Bet Rank = " + fiveCardRank.ToString() + Environment.NewLine;
            }
            ...
            if (GameState == GameStates.TurnBet)//the turn
            {
                ...
                //if (lblTestInfo) lblTestInfo.AppendText(virtualPlayers[player].Name + " #" + player.ToString() + " Turn Bet Rank = " + fiveCardRank.ToString() + Environment.NewLine);
                if (lblTestInfo) lblTestInfo.GetComponent<Text>().text += virtualPlayers[player].Name + " #" + player.ToString() + " Turn Bet Rank = " + fiveCardRank.ToString() + Environment.NewLine;
            }
            ...
            if (GameState == GameStates.RiverBet)//the river
            {
                ...
                if (lblTestInfo) lblTestInfo.GetComponent<Text>().text += virtualPlayers[player].Name + " #" + player.ToString() + " River Bet Rank = " + fiveCardRank.ToString() + Environment.NewLine;
            }
            //END RIVER 
            ...
            {
                AllInPlayer(player);
                if (lblTestInfo) lblTestInfo.GetComponent<Text>().text += virtualPlayers[player].Name + " " + player.ToString() + " IS ALL IN" + Environment.NewLine;
            }
            else
            {
                switch (BetType)
                {
                    case BetTypes.folding:
                        {
                            FoldPlayer(player);
                            if (lblTestInfo) lblTestInfo.GetComponent<Text>().text += virtualPlayers[player].Name + " " + player.ToString() + " FOLDED" + Environment.NewLine;
                        }
                        break;
                    case BetTypes.checking:
                        {
                            CheckPlayer(player);
                            if (lblTestInfo) lblTestInfo.GetComponent<Text>().text += virtualPlayers[player].Name + " " + player.ToString() + " CHECKED" + Environment.NewLine;
                        }
                        break;
                    case BetTypes.calling:
                        {
                            if (ThisPlayersCall >= virtualPlayers[player].Credits)
                            {
                                ...
                                if (lblTestInfo) lblTestInfo.GetComponent<Text>().text += virtualPlayers[player].Name + " " + player.ToString() + " ALL IN" + Environment.NewLine;
                            }
                            else
                            {
                                ...
                                virtualPlayers[player].RoundCallAmount += ThisPlayersCall;
                                CallPlayer(player);
                                if (lblTestInfo) lblTestInfo.GetComponent<Text>().text += virtualPlayers[player].Name + " " + player.ToString() + " CALLED" + Environment.NewLine;
                            }
                        }
                        break;
                    case BetTypes.raising:
                        {
                            ...
                            virtualPlayers[player].RoundCallAmount += ThisPlayersCall;
                            if (lblTestInfo) lblTestInfo.GetComponent<Text>().text += virtualPlayers[player].Name + " " + player.ToString() + " RAISED" + Environment.NewLine;
        ...
        PotAmount += ThisRoundBet;// virtualPlayers[player].FlopBet;
                                  //if (lblTestInfo) lblTestInfo.AppendText("Player " + player.ToString() + roundStr + ThisRoundBet.ToString() + Environment.NewLine);
    ...
    private void button2_Click(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(lblTemp.text)) lblTemp.text = data;
    }
    ...
    private void StartNewGame()
    {
        ...
        {
            try {
                if (lblTestInfo) lblTestInfo.GetComponentInChildren<Text>().text += " Player " + x.ToString() + " =" + virtualPlayers.ElementAt(x).Name + Environment.NewLine;
            }
            catch (Exception e) {
                if (Settings.isDebug) Debug.LogError("error in lblTestInfo: " + e.Message);
            }
        }
    ...
    public void startGame()
    {
		...
		if (btnNewGame) btnNewGame.SetActive(false);
        if (btnRepeatLastBet) btnRepeatLastBet.SetActive(false);
        if (btnBetNow) btnBetNow.GetComponent<Button>().interactable = false;
    ...
    {
        if (Settings.isDebug) Debug.Log("RenewVirtualPlayerProfiles()");
    ...
    {
        if (Settings.isDebug) Debug.Log("ResetVirtualPlayerVars()");
    ...
    {
        if (Settings.isDebug) Debug.Log("StartBetting()");
    ...
    {
        if (Settings.isDebug) Debug.Log("finishThisRoundBetting()");
        ...
        DisableBettingButtons();
        //if (btnStartGame) btnStartGame.GetComponent<Button>().interactable = false;
    }
    ...
    public void btnCallClick()//_Click(object sender, EventArgs e)
    {
        ...
        if (virtualPlayers.Count() > 0 && virtualPlayers.ElementAt(0) != null)
        {
            if (Settings.isDebug) Debug.Log("btnCallClick() virtualPlayers.Count = " + virtualPlayers.Count());
            double pBet = GetCurrentBet() - virtualPlayers.ElementAt(0).CurrentBetAmount;
    ...
    {
        if (Settings.isDebug) Debug.Log("checkForPlayerWin()");
    ...
    {
        if (Settings.isDebug) Debug.Log("GetCurrentBet()");
    ...
    {
        if (Settings.isDebug) Debug.Log("GetTotalRaiseAmount()");
    ...
    {
        if (Settings.isDebug) Debug.Log("GetPercentPotRaised()");
    ...
    {
        if (Settings.isDebug) Debug.Log("CheckForAllInShowdown()");
    ...
    {
        if (Settings.isDebug) Debug.Log("GetPlayerWithBestHand()");
    ...
    {
        if (Settings.isDebug) Debug.Log("CheckForBetFinish()");
    ...
    private void AwardPlayerWin()
    {
		if (Settings.isDebug) Debug.Log("AwardPlayerWin()");
        ...
        {
            if (btnRepeatLastBet) btnRepeatLastBet.SetActive(true);
            if (btnRepeatLastBet) btnRepeatLastBet.GetComponentInChildren<Text>().text = "REPEAT LAST BET OF " + FormatCreditsOrDollars(lastBet);
        }

        if (panelInitBet) panelInitBet.SetActive(false);
        if (btnNewGame) btnNewGame.SetActive(true);
    ...
    private double AwardVideoBonus(int split)
    {
        if (Settings.isDebug) Debug.Log("AwardVideoBonus()");

        if (payTable == null) return 0;
    ...
    {
        if (Settings.isDebug) Debug.Log("EndGame()");
		...
		if (panelInitBet) panelInitBet.SetActive(false);
        if (btnBetNow) btnBetNow.GetComponent<Button>().interactable = true;
        isNextPlayer = false;
    }

    private int GetWinner()
    {
        if (Settings.isDebug) Debug.Log("GetWinner()");
    ...
    private int GetKickerOld(int[] sevenCardHand, int[] cardsUsed)
    {
        if (Settings.isDebug) Debug.Log("GetKickerOld()");
    ...
    private int GetKicker(int[] sevenCardHand, int[] cardsUsed)
    {
        if (Settings.isDebug) Debug.Log("GetKicker()");
    ...
    {
        if (Settings.isDebug) Debug.Log("GetXofaKindKicker(int card, int[] hand)");
    ...
    {
        if (Settings.isDebug) Debug.Log("GetTwoPairKicker(int firstValue, int secondValue, int[] hand))");
    ...
    {
        if (Settings.isDebug) Debug.Log("NextPlayer()");
    ...
    {
        if (Settings.isDebug) Debug.Log("btnSurrenderClick()");
    ...
    {
        if (Settings.isDebug) Debug.Log("btnFoldClick()");
    ...
    private void startGameOverTimer(bool win)
    {
		...
		if (panelWin) {
			...
			if (lblWinPlayerName) {
				if (gameOverStrings.Count() > 1)
					lblWinPlayerName.GetComponent<Text> ().text = gameOverStrings.ElementAt(1) + "\n\n";
        ...
        if (jurisdictionalLimit != 0)
        {
            ...
            {
                //if (btnCredit) btnCredit.SetActive(true);
            }
    ...
    {
        if (Settings.isDebug) Debug.Log("stopGameOverTimer");
    ...
    {
        if (Settings.isDebug) Debug.Log("RoundDown(Amount ="+Amount);
    ...
    {
        if (Settings.isDebug) Debug.Log("RoundUp(Amount =" + Amount);
    ...
    private int GetPlayerPairValue(int player)
    {
        if (Settings.isDebug) Debug.Log("GetPlayerPairValue()");
    ...
    private int GetNotFoldedPlayerCount()
    {
        if (Settings.isDebug) Debug.Log("GetNotFoldedPlayerCount()");
    ...
    private PairTypes GetPairType(int[] hand)
    {
        if (Settings.isDebug) Debug.Log("GetPairType()");
    ...
    {
        if (Settings.isDebug) Debug.Log("UseTestData()");
    ...
    {
        if (Settings.isDebug) Debug.Log("btnAutoPlayClick()");

        AutoPlay = !AutoPlay;
        if (AutoPlay == true)
        {
			if (btnAutoPlay) btnAutoPlay.GetComponentInChildren<Text>().text = "Man. Play";
        ...
        {
			if (btnAutoPlay) btnAutoPlay.GetComponentInChildren<Text>().text = "Auto Play";
    ...
    {
        if (Settings.isDebug) Debug.Log("isAnteBet()");
    ...
    {
        if (Settings.isDebug) Debug.Log("btnRepeatBetClick()");

        // get last bet from input field of the PanelInitBet
        if (lastBet > 0)
        {
            isFromRepeatBetBtn = true;
            betAmount = lastBet;
            btnStartGameClick();
        }
    }
    ...
    public void btnCreditAddClick() //addCredit_Click_1(object sender, EventArgs e)
    {
        ...
        //if (btnCredit) btnCredit.SetActive(false);
    }
    ...
    public void btnStartGameClick()
    {
        ...
        if (betAmount > 0) {
            isFromBetOkBtn = true;
			if (lblPanelBet) lblPanelBet.GetComponent<Text>().text = "RAISE AMOUNT";
            ...
            if (btnRepeatBet) btnRepeatBet.SetActive(false);
...
//			audio.PlayOneShot(dealSound);
    ...
    public void OtherInits() {
		...
		if (FileIni != null && (FileIni.isExists(iniFile) || !Settings.isIgnoreIniFile))
        {
            ...
            {
                if (btnAllIn) btnAllIn.SetActive(false);
        ...
        {
			realPlayerName = Settings.realPlayerName;
    ...
    public void Start()
    {
        ...
        if (panelAddCredits) {
			...
			if (btnCreditOk) btnCreditOk.GetComponent<Button>().onClick.AddListener(() => btnCreditOkClickListener());
        ...
        lblTestInfo = GameObject.Find("lblTestInfo");
        ...
        btnCredit = GameObject.Find("btnCredit");
       	if (btnCredit) btnCredit.GetComponent<Button>().onClick.AddListener(() => btnCreditAddClickListener());
		...
		if (btnBetNow) btnBetNow.GetComponent<Button>().onClick.AddListener(() => btnBetNowClickListener());
		if (btnStartGame) btnStartGame.GetComponent<Button>().onClick.AddListener(() => btnStartGameClickListener());
		if (btnRaise) btnRaise.GetComponent<Button>().onClick.AddListener(() => btnRaiseClickListener());
		if (btnCall) btnCall.GetComponent<Button>().onClick.AddListener(() => btnCallClickListener());
		if (btnCheck) btnCheck.GetComponent<Button>().onClick.AddListener(() => btnCheckClickListener());
		if (btnSurrender) btnSurrender.GetComponent<Button>().onClick.AddListener(() => btnSurrenderClickListener());
		if (btnAllIn) btnAllIn.GetComponent<Button>().onClick.AddListener(() => btnAllInClickListener());
		if (btnRepeatBet) btnRepeatBet.GetComponent<Button>().onClick.AddListener(() => btnRepeatBetOfBetFormClickListener());
...
//		Debug.Log (Time.time);
    ...
    GameObject txtSurrender, lblSurrender, lblTestInfo;//panel surrender
